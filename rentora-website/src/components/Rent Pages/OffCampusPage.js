...
import OffCampusHousingFormStep23 from './OffCampusFormSteps/OffCampusHousingFormStep23';
    ...
    return (
      <div>
        <Routes>
          ...
          <Route path="step23" element={<OffCampusHousingFormStep23 onComplete={completeForm} />} />
        </Routes>
      </div>
    );
  }
